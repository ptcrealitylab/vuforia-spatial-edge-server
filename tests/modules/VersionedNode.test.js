...
describe("VersionedNode", () => {
    ...
    const emptyState = {};
    test("constructor", () => {
        expect(() => {new VersionedNode(new ValueStore(0));}).not.toThrow();
    });
    test("constructor with type", () => {
        expect(() => {new VersionedNode(new ValueStore(0), "test");}).not.toThrow();
    });
    test("constructor sets correct value", () => {
        const node = new VersionedNode(new ValueStore(0));
    ...
    test("constructor sets correct custom type", () => {
        const node = new VersionedNode(new ValueStore(0), "test");
    ...
    test("return correct state when not dirty", () => {
        const node = new VersionedNode(new ValueStore(0), VersionedNode.TYPE, 0);
    ...
    test("set correct state when not dirty", () => {
        const node = new VersionedNode(new ValueStore(1));
        node.getChanges();
