...
class AFrameWorker {
    ...
    constructor() {
        this.clientState = AFrameWorker.STATE_CONSTRUCTED;
    ...
    onMessageFromInterface(event) {
        ...
        if (message.hasOwnProperty("name")) {
            if (message.name === "touchDecider") {
                let result = false;
                if (this.clientState !== AFrameWorker.STATE_CONTEXT_LOST) {
                ...
                switch (this.clientState) {
                    case AFrameWorker.STATE_CONSTRUCTED:
                    case AFrameWorker.STATE_BOOTSTRAP_DONE:
                    case AFrameWorker.STATE_FRAME_DONE:
                    case AFrameWorker.STATE_CONTEXT_RESTORED_DONE:
                ...
                if (this.clientState == AFrameWorker.STATE_CONSTRUCTED) {
                    this.clientState = AFrameWorker.STATE_BOOTSTRAP;
                    ...
                    this.clientState = AFrameWorker.STATE_BOOTSTRAP_DONE;
                } else {
                ...
                switch (this.clientState) {
                    ...
                    case AFrameWorker.STATE_FRAME_DONE:
                    case AFrameWorker.STATE_CONTEXT_RESTORED_DONE:
                        this.clientState = AFrameWorker.STATE_FRAME;
                        // safety checks
                        ...
                        if (!this.bootstrapProcessed) {
                            ...
                            this.clientState = AFrameWorker.STATE_FRAME_DONE;
                            return;
                        }
                ...
                switch (this.clientState) {
                    case AFrameWorker.CONSTRUCTED:
                    case AFrameWorker.STATE_BOOTSTRAP_DONE:
                    case AFrameWorker.STATE_FRAME_DONE:
                    case AFrameWorker.STATE_CONTEXT_RESTORED_DONE:
                        this.clientState = AFrameWorker.STATE_CONTEXT_LOST;
                        this.onContextLost();
                        break;
                    default:
                ...
                if (this.clientState === AFrameWorker.STATE_CONTEXT_LOST) {
                    this.clientState = AFrameWorker.STATE_CONTEXT_RESTORED;
                    this.onContextRestored();        
                    this.clientState = AFrameWorker.STATE_CONTEXT_RESTORED_DONE;
                } else {
...
export {AFrameWorker, setMatrixFromArray};
