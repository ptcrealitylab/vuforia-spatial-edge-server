(function(exports) {
    class LanguageInterface {
        ...
        constructor(applicationName, objectId, applicationId) {
            ...
            if (!this.objectId) console.warn(`LanguageInterface initialized for ${applicationName} with null object ID`);
            if (!this.applicationId) console.warn(`LanguageInterface initialized for ${applicationName} with null frame ID`);
